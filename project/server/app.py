...
client = iota_client.Client(nodes_name_password=[["https://api.lb-1.h.chrysalis-devnet.iota.cafe/"]])
...
# Receive MQTT msg
result = client.get_message_data("4fbfe5058d3d2f5f6c43458959b4b5a28c04b9ac9a2cd6264ff8ede050a97e2b")
